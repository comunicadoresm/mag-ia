...
export function FirstScriptSuggestion({ suggestion, onGenerate, onSkip, generating }: FirstScriptSuggestionProps) {
  return (
    <div
      className="min-h-screen flex flex-col px-5 py-8 animate-fade-in"
      style={{
        background: `
    ...
    >
      ...
      <div className="text-center mt-6 animate-slide-up">
        <div className="text-5xl mb-2 animate-[bounce_2s_ease-in-out_infinite]">🎯</div>
      ...
      {/* Suggestion Card */}
      <div className="bg-[#292929] border border-white/[0.06] rounded-2xl p-5 mt-5 animate-slide-up" style={{ animationDelay: '100ms' }}>
        {/* AI Badge */}
        <span className="
      ...
      {/* CTAs */}
      <div className="space-y-3 mt-6 animate-slide-up" style={{ animationDelay: '200ms' }}>
        <button
          onClick={onGenerate}
          disabled={generating}
          className="
